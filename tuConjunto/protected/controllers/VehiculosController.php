...
class VehiculosController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'update' actions
                ...
                'roles' => array(CrugeAuthitem2::$rolVigilante,CrugeAuthitem2::$rolAdministrador,
    ...
    public function actionCreate() {
        ...
        $model->idDueno = $contacto->idContacto;
        ...
        if (isset($_POST['Vehiculos'])) {
            ...
            $vehiculosPersistence = new VehiculosPersistence;
            if ($vehiculosPersistence->crearVehiculo($model)) {
                $this->redirect(array('view', 'id' => $model->idVehiculo));
            }
        }
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Vehiculos'])) {
            ...
            $vehiculosPersistence = new VehiculosPersistence;
            if ($vehiculosPersistence->modificarVehiculo($model)) {
                $this->redirect(array('view', 'id' => $model->idVehiculo));
            }
        }
...
//        $vehiculo = Vehiculos::model()->getVehiculo(Yii::app()->user->id);
        $model = Vehiculos::model()->findByPk($id);
//        if ($model === null || ($model !== null && vehiculo != null && $model->idVehiculo != $vehiculo->idVehiculo)) {
