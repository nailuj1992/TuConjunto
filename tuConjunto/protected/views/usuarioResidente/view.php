...
<h1 class="font_titulo">
    <i class="fa fa-user"></i> Ver a <?php echo $model->username; ?></h1>
    <br>
...
echo CHtml::link('Ver los usuarios residentes', array('index'), array('class' => 'btn btn-info'));
...
echo SiteController::$espacio_vacio;
echo CHtml::link('Modificar usuario residente', array('update', 'id' => $model->iduser), array('class' => 'btn btn-success'));
echo SiteController::$espacio_vacio;
