...
<div class="ibox-content">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'username', array('class' => 'font_titulo')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'email', array('class' => 'font_titulo')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'password', array('class' => 'font_titulo')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'idConjunto', array('class' => 'font_titulo')); ?>
        <?php
        echo CHtml::activeDropDownList($model, 'idConjunto', CHtml::listData(Conjuntos::model()->findAll(), 'idConjunto', 'nombre'), array(
            'empty' => Conjuntos::$seleccioneConjunto,
            'class' => 'form-control font_texto',
        ));
        ?>
        <?php echo $form->error($model, 'idConjunto', array('class' => 'font_texto')); ?>
    </div>
    ...
    <div class="container">
        ...
        echo CHtml::link('Volver', $model->isNewRecord ? array('index') : array('view', 'id' => $model->iduser), array('class' => 'btn btn-danger'));
        echo SiteController::$espacio_vacio;
        ?>
    </div>
