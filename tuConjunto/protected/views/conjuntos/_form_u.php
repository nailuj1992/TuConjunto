...
<div class="ibox-content">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'nit', array('class' => 'font_titulo2')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'direccion', array('class' => 'font_titulo2')); ?>
    ...
    $ciudad = Ciudades::model()->findByPk($idCiudad);
    $depto = Departamentos::model()->findByPk($ciudad->Departamentos_idDepartamentos);
    ?>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'departamento', array('class' => 'font_titulo2')); ?>
        <?php
        $model->departamento = $depto->idDepartamentos;
        echo CHtml::activeDropDownList($model, 'departamento', CHtml::listData(Departamentos::getDepartamentos(), 'idDepartamentos', 'nombre'), array(
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'Ciudades_idCiudades', array('class' => 'font_titulo2')); ?>
        <?php
        $idDepto = $model->departamento;
        $model->Ciudades_idCiudades = $idCiudad;
        ?>
        <?php if (isset($idDepto) && $idDepto != " " && Departamentos::model()->findByPk($idDepto)) { ?>
            <?php
            echo CHtml::activeDropDownList($model, 'Ciudades_idCiudades', CHtml::listData(Ciudades::getCiudadesDepto($idDepto), 'idCiudades', 'nombre'), array(
            ...
            echo CHtml::activeDropDownList($model, 'Ciudades_idCiudades', array('empty' => Ciudades::$seleccioneCiudad), array('class' => 'form-control font_texto'));
        }
        ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'estrato', array('class' => 'font_titulo2')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'logo', array('class' => 'font_titulo2')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'dominio', array('class' => 'font_titulo2')); ?>
    ...
    <div class="form-group">
        ...
        echo CHtml::link('Volver', array('view', 'id' => $model->idConjunto), array('class' => 'btn btn-danger'));
        echo SiteController::$espacio_vacio;
        ?>
    </div>
