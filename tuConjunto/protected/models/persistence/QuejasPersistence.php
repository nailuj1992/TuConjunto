 ...
 */
class QuejasPersistence {

    /**
     * Permite crear una queja.
     * @param type $model Informacion de la queja.
     * @return boolean
     */
    public function crearQueja($model) {
       if ($model->save()) {
            return true;
        }
        return false;
     ...
     * @return boolean
     */
    public function modificarQueja($model) {
