...
class Imagenes extends CActiveRecord {
    ...
    public static $widthImagen = 500;
    public static $maximoImagenes = 4;
    public static $size = 10; // en MB
    ...
    public function rules() {
        ...
        return array(
            ...
            array('idImagen, nombre, Conjuntos_idConjunto', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function buscar($idConjunto) {
        return new CActiveDataProvider($this, array(
            'criteria' => self::buscarCriteria($idConjunto),
        ));
    }

    public static function buscarCriteria($idConjunto) {
        $criteria = new CDbCriteria;
