 ...
 *
 * The followings are the available columns in table 'contactenos':
...
class Contactenos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('dirigidoA, mensaje', 'required'),
			array('dirigidoA, mensaje', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idContacto, dirigidoA, mensaje', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('dirigidoA',$this->dirigidoA,true);
